...
public:
    ...
    const char TOP = 205, TOP_LEFT = 201, TOP_RIGHT = 187, LEFT = 186,
            RIGHT = 186, BOTTOM = 205, BOTTOM_LEFT = 200, BOTTOM_RIGHT = 188,
            BLOCK = 223;
    // Framing (Unix mode)
    ...
    //"╝", BLOCK = "▀";
    // Colors
    enum Color: uint8_t { BLACK = 0, RED, DARK_GREEN, GOLD, BLUE, GARNETT, ORANGE,
        LIGHT_GRAY,
        GRAY, PEACH, GREEN, BRIGHT_GOLD, CYAN, MAGENTA,
        BRIGHT_ORANGE, WHITE };
    // Special symbols
    ...
    inline static ConsoleGfx* getInstance() { return instance ? instance : instance
                                                                                   = new ConsoleGfx(); }
